...
class Db {  
    ...
    private function __construct() {  
        try {  
            ...
            $this->_pdo = new PDO("mysql:host=" . $_SC["db"]["host"] . ";dbname=" . $_SC["db"]["dbname"], $_SC["db"]["username"], $_SC["db"]["password"], array(PDO::MYSQL_ATTR_INIT_COMMAND=>'SET NAMES '.$_SC['dbcharset']));  
