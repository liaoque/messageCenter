<?php
require_once ROOT . '/lib/ali/aop/request/AlipayTradePagePayRequest.php';
 ...
 * Time: 11:33
 */
class PayDrive_AlipayWebPay extends PayDrive_AlipayPayBase implements PayDrive_InterfacePay
{
