...
class jPushDrive_DevicePayload {
    ...
    public function getDevices($registrationId) {
        $url = jPushDrive_DevicePayload::DEVICE_URL . $registrationId;
    ...
    public function getTags() {
        $url = jPushDrive_DevicePayload::TAG_URL;
        return jPushDrive_Http::get($this->client, $url);
    }
    ...
    public function updateTag($tag, $addDevices = null, $removeDevices = null) {
        ...
        $url = jPushDrive_DevicePayload::TAG_URL . $tag;
    ...
    public function getDevicesStatus($registrationId) {
        ...
        $url = jPushDrive_DevicePayload::DEVICE_STATUS_URL;
        return jPushDrive_Http::post($this->client, $url, $payload);
    }
}
