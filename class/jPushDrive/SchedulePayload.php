...
class jPushDrive_SchedulePayload {
    ...
    public function createSingleSchedule($name, $push_payload, $trigger) {
        ...
        $url = jPushDrive_SchedulePayload::SCHEDULES_URL;
        return jPushDrive_Http::post($this->client, $url, $payload);
    }
    ...
    public function updateSingleSchedule($schedule_id, $name=null, $enabled=null, $push_payload=null, $trigger=null) {
        ...
        $url = jPushDrive_SchedulePayload::SCHEDULES_URL . "/" . $schedule_id;

        return jPushDrive_Http::put($this->client, $url, $payload);
    ...
    public function getSchedules($page = 1) {
        ...
        $url = jPushDrive_SchedulePayload::SCHEDULES_URL . "?page=" . $page;
    ...
    public function deleteSchedule($schedule_id) {
        ...
        $url = jPushDrive_SchedulePayload::SCHEDULES_URL . "/" . $schedule_id;
        return jPushDrive_Http::delete($this->client, $url);
    }
}
